...
Колекція HTML-шаблонів українською для навчання, самоорганізації та менеджменту. Готові до вбудовування в Notion через `/embed`.
...
- Або завантажте `.html` і використовуйте локально.
